...
public class StartSimulation {
    ...
    private static final Long defaultRandomSeed1 = Long.valueOf(22021924);
    private static final Long defaultRandomSeed2 = Long.valueOf(22022022);
    private static final Long defaultRandomSeed3 = Long.valueOf(22021957);
    private static final Long defaultRandomSeed4 = Long.valueOf(22021918);
	...
	try {
	    ...
	    parameterArray[5] = Double.parseDouble(prop.getProperty(propName));
 	    propName = "h";
 	    parameterArray[6] = Double.parseDouble(prop.getProperty(propName));
	}        
	catch (Exception e) {
