...
% filenames 
directory = '/panfs/panasas01/bisc/ss16191/Forschung/Programme/OutgroupConflict_FawcettRadford/EffectParameter_mu/Output/';
seedFilename = '../listOfRandomSeeds_100simulations';
filename = 'populationOverTime_mu_';
outputFilename = 'mergedResults_effectParameter_mu';
...
%% parameters
noAttractors = 9;
muArray = 0.05:0.05:0.5;
noParameter = length(muArray);
aportCond = false;

%% load initial file to extract parameters
resultMat = load([string(strcat(directory,filename,num2str(muArray(1)),'_',seeds{1}(1)))]);
