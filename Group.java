...
public class Group {
	...
	if (checkValueBetween0and1(candWf-0.00001) || checkValueBetween0and1(candWf+0.00001))
	    wf = candWf;
	else{
	    wf = defaultWf;
	...
	if (checkValueBetween0and1(candAf))
	    ...
	    if (checkValueBetween0and1(candAf-0.00001) || checkValueBetween0and1(candAf+0.00001))
	...
	if (checkValueBetween0and1(candWAf))
	    ...
	    if (checkValueBetween0and1(candWAf-0.00001) || checkValueBetween0and1(candWAf+0.00001))
	...
	if (checkValueBetween0and1(candWDf))
	    ...
	    if (checkValueBetween0and1(candWDf-0.00001) || checkValueBetween0and1(candWDf+0.00001))
