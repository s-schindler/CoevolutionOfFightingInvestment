...
public class IterateModel {
	...
	for (int i=0; i<numberIterations; i++){
	    ...
	    // if (currentPopulation.getSDfitness()>SDthresholdForStrongSelection){
	    // 	newGeneration = Selection.selectAndMutateGroups_truncatedSelection(currentPopulation,currentPopulation.getMeanFitness(),currentPopulation.getSumFitness());
	    // 	countStrongSelectionOperator++;
	    // }
	    // else{
	    	newGeneration = Selection.selectAndMutateGroups_proportionalSelection(currentPopulation,currentPopulation.getSumFitness());
	...
	System.out.println("\n Simulation ended.");
	//	System.out.println("\n Simulation ended. \n No of rounds with truncated selection = "+countStrongSelectionOperator+". \n No of rounds with proportional selection = "+countPropSelectionOperator+".");
    }
