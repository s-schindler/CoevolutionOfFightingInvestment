...
% filenames 
directory = '/panfs/panasas01/bisc/ss16191/Forschung/Programme/OutgroupConflict_FawcettRadford/EffectParameter_cm/Output/';
seedFilename = '../listOfRandomSeeds_100simulations';
filename = 'populationOverTime_cm_';
outputFilename = 'mergedResults_effectParameter_cm';
...
for param =1:noParameter
  disp(['cm value = ' num2str(cmArray(param))])
