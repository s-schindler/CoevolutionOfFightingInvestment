...
% filenames 
directory = '/panfs/panasas01/bisc/ss16191/Forschung/Programme/OutgroupConflict_FawcettRadford/EffectParameter_k/Output/';
seedFilename = '../listOfRandomSeeds_100simulations';
filename = 'populationOverTime_k_';
outputFilename = 'mergedResults_effectParameter_k';
...
noParameter = length(kArray);
aportCond = false;

%% load initial file to extract parameters
resultMat = load([string(strcat(directory,filename,num2str(kArray(1)),'_',seeds{1}(1)))]);
