...
% filenames 
directory = '/panfs/panasas01/bisc/ss16191/Forschung/Programme/OutgroupConflict_FawcettRadford/WithHomeAdvantage/Output/';
seedFilename = '../listOfRandomSeeds_100simulations';
filename = 'populationOverTime_h';
outputFilename = 'mergedResults_effectParameter_homeAdvantage';
...
noAttractors = 9;
hArray = -1:0.1:1;
stringInsets = {'-1','-09','-08','-07','-06','-05','-04','-03','-02','-01','0','01','02','03','04','05','06','07','08','09','1'};
noParameter = length(hArray);
aportCond = false;
...
for param =1:noParameter
  disp(['K value = ' num2str(hArray(param))])
